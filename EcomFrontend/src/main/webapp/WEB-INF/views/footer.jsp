...
footer { background-color:#00547E; min-height:350px; font-family: 'Open Sans', sans-serif; }
...
.footer-ul li a:hover {transition: color 0.2s linear 0s, background 0.2s linear 0s; color:#ff670f; }
 ...
 .copyright { min-height:40px; background-color:#04A3ED;}
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 footer-col">
        ...
        <ul class="footer-social">
          ...
          <li><a href="https://www.googleplus.com"><i class="fa fa-google-plus social-icon google" aria-hidden="true"></i></a></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="copyright">
  <div class="container">
    <div class="col-md-6">
      <p>© 2019 - All Rights with Thomas</p>
    </div>
    <div class="col-md-6">
      <ul class="bottom_ul">
        <li><a href="#">developerthomas.com</a></li>
